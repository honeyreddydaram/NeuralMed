...
def build_story():
    ...
    s.append(SH("D.  Patient Portal — Parkinson's Disease"))
    s += screen('p13_parkinsons_form.png',
                "Fig. 16. Parkinson's — patient input form (8 voice features).")
    s += screen('p14_parkinsons_detected.png',
                "Fig. 17. Parkinson's — Parkinson's Detected result.")
    s += screen('p15_parkinsons_not_detected.png',
                "Fig. 18. Parkinson's — No Parkinson's Detected result.")
