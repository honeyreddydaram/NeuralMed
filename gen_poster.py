...
def build():
    ...
    concl_rows = [
        ...
        [HR(color=PRIMARY)],
        [SP(6)],
        [P('References', sSubHead)],
        [P('[1] G. Obermeyer & E. Emanuel, "Predicting the Future — Big Data, ML, and Clinical Medicine," <i>NEJM</i>, 2016.', S('r1',T,16,21,TA_LEFT,MUTED,spaceAfter=3))],
        [P('[2] F. Pedregosa et al., "Scikit-learn: Machine Learning in Python," <i>JMLR</i>, vol. 12, 2011.', S('r2',T,16,21,TA_LEFT,MUTED,spaceAfter=3))],
        [P('[3] K. Simonyan & A. Zisserman, "Very Deep Convolutional Networks," <i>ICLR</i>, 2015.', S('r3',T,16,21,TA_LEFT,MUTED,spaceAfter=3))],
        [P('[4] T. Chen & C. Guestrin, "XGBoost: A Scalable Tree Boosting System," <i>KDD</i>, 2016.', S('r4',T,16,21,TA_LEFT,MUTED,spaceAfter=3))],
        [P('[5] K. Singhal et al., "Large Language Models Encode Clinical Knowledge," <i>Nature</i>, 2023.', S('r5',T,16,21,TA_LEFT,MUTED,spaceAfter=3))],
        [SP(8)],
        [HR(color=PRIMARY)],
        [SP(6)],
